...
# Generated on: Wed Oct 09 12:06:24 IST 2024 (Wed Oct 09 06:36:24 UTC 2024)
...
set logfile fv/cordic_pipeline/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/cordic_pipeline -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /home/vlsi/Cordic/cordic.v
elaborate_design -golden -root {cordic_pipeline} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/cordic_pipeline/fv_map.v.gz
elaborate_design -revised -root {cordic_pipeline}
...
#add_name_alias fv/cordic_pipeline/fv_map.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.cordic_pipeline.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.cordic_pipeline.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.cordic_pipeline.rtl.fv_map.rpt
